...
* 再谈二进制
  * 长度为 7 的金条 //1,2,4...可组合出2^n-1以内所有整数
  * 问题及扩展     //其中一个整数,只有一种组合可以组合出来.可以用二进制证明,每位权重为1,2,4,8,16...
* 十六进制
            ...
            * 表单标签
                ...
                - input
                    + type属性的各项值
                        ...
                        * month
                        * tel
                        * range  //默认0-100,但可以通过下面设置范围,范围随意设置,和跨度
                            - min，4
                            - max，10
                            - step，2
                        * color
